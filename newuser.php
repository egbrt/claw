...
function showPrivacyStatement()
{
    ...
    echo "These are needed to login to the classification workbench.</p>";
    ...
    echo "<p>Welcome to the classification workbench, offered by the ICPC-3 Foundation.</p>";
    ...
    echo "<p>The database collects personal information to provide you with a personalized, useful and efficient experience. However, in each instance we collect only the minimum personally identifiable information necessary for the classification workbench. The categories of information we collect can include:</p>";
    ...
    echo "<h2>Your Consent</h2>";
    echo "<p>We may share or disclose the information you provided concerning the ICPC-3 with your consent.</p>";
    echo "<h2>How to Contact Us</h2>";
    echo "<p>If you have any questions about our practices or this Privacy Policy, please contact us at info@icpc-3.info.</p>";
    echo "</div>";
